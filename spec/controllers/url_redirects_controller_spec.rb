...
describe UrlRedirectsController do
  ...
  describe "GET membership_inactive_page", inertia: true do
    ...
    it "renders the Inertia component with props for subscriptions that can be restarted" do
    ...
    it "renders the Inertia component with props for subscriptions that cannot be restarted" do

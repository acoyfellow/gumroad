    ...
    describe "product_title_query" do
      ...
      context "when query is set" do
        it "filters by product title" do
          ...
          expect_any_instance_of(Admin::Search::PurchasesService).to receive(:new).with(query: email, product_title_query:, purchase_status: nil).and_call_original
      ...
      context "when query is not set" do
        it "ignores product_title_query" do
          expect_any_instance_of(Admin::Search::PurchasesService).to receive(:new).with(query: "", product_title_query:, purchase_status: nil).and_call_original
    ...
    describe "purchase_status" do
      ...
      context "when query is set" do
        it "filters by purchase status" do
          ...
          expect_any_instance_of(Admin::Search::PurchasesService).to receive(:new).with(query: email, product_title_query: nil, purchase_status:).and_call_original
      ...
      context "when query is not set" do
        it "ignores purchase_status" do
          expect_any_instance_of(Admin::Search::PurchasesService).to receive(:new).with(query: "", product_title_query: nil, purchase_status:).and_call_original

...
describe WorkflowsPresenter do
  ...
  let!(:workflow3) { create(:workflow, link: product, seller:, published_at: 1.day.ago) }
  let!(:workflow4) { create(:workflow, link: nil, seller:, workflow_type: Workflow::SELLER_TYPE, published_at: 1.day.ago) }
  ...
  describe "#workflow_options_by_purchase_props" do
    it "calls service and formats workflow options" do
      ...
      create(:workflow_installment, workflow: workflow1, seller:, published_at: 1.day.ago)
      create(:workflow_installment, workflow: workflow2, seller:,  deleted_at: DateTime.current)
      create(:workflow_installment, workflow: workflow3, seller:, published_at: 1.day.ago)
      create(:workflow_installment, workflow: workflow4, seller:, published_at: 1.day.ago)

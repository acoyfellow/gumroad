...
class Products::Edit::RecieptController < Products::Edit::BaseController
  def show
    ...
    render inertia: "Products/Edit/Receipt", props: @presenter.edit_props
  end
  ...
  def update
    begin
      ...
      return redirect_to products_edit_receipt_edit_show_path(@product.external_id)
    end
    ...
    redirect_to products_edit_receipt_edit_show_path(@product.external_id)
  end
end

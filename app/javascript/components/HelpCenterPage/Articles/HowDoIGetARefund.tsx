...
export const HowDoIGetARefundDescription =
  "In this article: Website purchases In-app purchases Website purchases When you buy a product from a Gumroad creator, Gumroad only processes payments on behalf o";
  ...
  return (
    <>
      <div>
        ...
        <ul>
          <li>
            <a href="#Website-purchases-YEQit">Website purchases</a>
          </li>
          <li>
            <a href="#In-App-Purchases-GL6fX">In-app purchases</a>
          </li>
        </ul>
        <hr role="separator" />
        ...
        <p>
          ...
          <a href="https://gumroad.com/help/article/283-fraudulent-purchases">fraudulent</a> or a duplicate.
        </p>
        <p>
          Please write to us if you haven’t heard back from the creator for 30 days since first contacting them, along
          with the proof of correspondence. We will reach out to them and will issue a refund if they continue to be
          unresponsive.
        </p>
        <p>
          If you have issues with the product you've purchased through Gumroad or feel you deserve a refund, you should
          contact the creator of the product.{" "}
        </p>
        <p>You can contact the creator by replying directly to your receipt email:</p>
        <figure>
          <img src="https://lh7-us.googleusercontent.com/dl2KcyB6VcgKyQjf_PdY7mSpA3PwCXm4kfCzmq-kbi0hRee7mzCRjIG0oLOuAjucAk-1Z6uEl4rVS-LeIjd58epUux48b0Sm1QhY_AhBPSZWAKgINSkHcFiWMTNUEOlYlYG5KdDpPdhuOhJk3_7RebM" />
        </figure>
        <p>or by looking at the "reply-to" information on your purchase email</p>
        <h3></h3>
        <figure>
          <img src="https://d33v4339jhl8k0.cloudfront.net/docs/assets/5c4657ad2c7d3a66e32d763f/images/61fb919bd86136157d9a05c5/file-kV4glDwBbx.png" />
        </figure>
        <p>
        ...
        <br />
        <p>
          If you need a refund for an in-app purchase, please contact{" "}
          <a href="https://support.apple.com/en-au/118223">Apple</a> (for IOS devices) or{" "}
          <a href="https://support.google.com/googleplay/answer/2479637?sjid=15689087848422407774-AP">Google support</a>{" "}
          (for Android devices).
        </p>
      </div>
      <div>

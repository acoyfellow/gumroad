...
export const MyPurchaseIsntDownloadingDescription =
  "Here are the most common reasons why a download may not be working from Gumroad: Downloading on mobile devices Please use our mobile app to download files direc";

export default function MyPurchaseIsntDownloading() {
  return (
    <>
      <div>
        ...
        <p>
          Gumroad supports all modern, updated browsers. <a href="http://www.browsehappy.com/?locale=en">Click here</a>{" "}
          to find out if your browser is up-to-date. Older browsers are not only more prone to errors, but they are less
          safe to use (i.e. they are more easily hacked). We highly recommend using{" "}
          <a href="https://www.google.com/chrome/">Google Chrome</a> for the best results. Avoid using discontinued
          browsers like Internet Explorer.
        </p>
        <h3>Extensions</h3>
        <p>
          If you have extensions or add-ons such as Adblock or Ghostery etc. running, your ability to download larger
          files might be impaired. If you temporarily disable those features, then refresh the download page, the
          download may work better.
        </p>
        <p>You can disable extensions from your browser’s settings.</p>
        <h3>File format</h3>
        <p>
          If you don't recognize the file format and don't know how it's meant to be used, you can reply directly to
          your receipt to get in contact with the creator who can provide tech support.
        </p>
        <p>

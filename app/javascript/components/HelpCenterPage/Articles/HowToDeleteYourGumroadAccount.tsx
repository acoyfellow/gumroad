...
export const HowToDeleteYourGumroadAccountDescription =
  "Account deletions are permanent and cannot be reversed. Before you delete your account, we highly recommend that you: Change your account’s email address if you";

export default function HowToDeleteYourGumroadAccount() {
  return (
    <>
      <div>
        <p>
          Account deletions are permanent and cannot be reversed. Before you delete your account, we highly recommend
          that you:
        </p>
        <ul>
        ...
        <p>
          To delete your account, go to your <a href="https://gumroad.com/settings/advanced">settings</a>, scroll down
          to the bottom, and click 'Delete your Gumroad account!'
        </p>
        <figure>
          <img src="https://d33v4339jhl8k0.cloudfront.net/docs/assets/5c4657ad2c7d3a66e32d763f/images/658ba8b015d4597b5fb209ad/file-ch8xxL6pcQ.png" />
        </figure>
        <p>
        ...
        <p>
          ...
          data get permanently deleted as well.
        </p>
      </div>
      <div>
